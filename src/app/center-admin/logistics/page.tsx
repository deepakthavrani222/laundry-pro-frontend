...
export default function LogisticsPartnersPage() {
  ...
  const fetchPartners = async () => {
    try {
      ...
      const res = await fetch(`${API_URL}/center-admin/logistics/partners?${params}`, {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const url = editingPartner 
        ? `${API_URL}/center-admin/logistics/partners/${editingPartner._id}`
        : `${API_URL}/center-admin/logistics/partners`
  ...
  const handleToggleStatus = async (id: string) => {
    try {
      const res = await fetch(`${API_URL}/center-admin/logistics/partners/${id}/toggle-status`, {
        method: 'PATCH',
        headers: getAuthHeaders()
      })
  ...
  const handleDelete = async (id: string, name: string) => {
    ...
    try {
      const res = await fetch(`${API_URL}/center-admin/logistics/partners/${id}`, {
        method: 'DELETE',
        headers: getAuthHeaders()
      })
      if ((await res.json()).success) fetchPartners()
  ...
  const fetchSettlement = async () => {
    ...
    try {
      const res = await fetch(
        `${API_URL}/center-admin/logistics/partners/${settlementPartnerId}/settlement?month=${settlementMonth}&year=${settlementYear}`,
        { headers: getAuthHeaders() }
      )
      const data = await res.json()
