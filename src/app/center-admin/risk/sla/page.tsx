...
export default function SLAConfigPage() {
  ...
  const fetchConfigs = async () => {
    try {
      setLoading(true)
      setError('')
      const response = await centerAdminApi.getSLAConfigurations({ page: pagination.current, limit: 20 })
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      await centerAdminApi.createSLAConfiguration(newConfig)
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Link href="/center-admin/risk" className="p-2 hover:bg-gray-100 rounded-lg">
