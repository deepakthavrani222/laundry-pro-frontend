...
export default function ComplaintDetailPage() {
  ...
  const handleEscalate = async () => {
    ...
    try {
      ...
      await centerAdminApi.escalateComplaint(complaintId, escalateReason, escalateLevel)
  ...
  const handleResolve = async () => {
    ...
    try {
      setActionLoading(true)
      await centerAdminApi.resolveComplaint(complaintId, resolution, resolutionType, resolutionAmount || undefined)
    ...
    return (
      <div className="p-6">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
          ...
          <Link href="/center-admin/risk/complaints">
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Link href="/center-admin/risk/complaints" className="p-2 hover:bg-gray-100 rounded-lg">
