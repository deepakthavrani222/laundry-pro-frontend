  ...
  return (
    <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border">
              <div className="p-4 border-b border-gray-200">
                <div className="flex justify-between items-center">
                  ...
                  <Link
                    href="/center-admin/risk/complaints?isEscalated=true"
                    ...
                    {escalatedComplaints.slice(0, 5).map((complaint) => (
                      <div key={complaint._id} className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Link
                            href={`/center-admin/risk/complaints/${complaint._id}`}
            ...
            <div className="bg-white rounded-lg shadow-sm border">
              <div className="p-4 border-b border-gray-200">
                <div className="flex justify-between items-center">
                  ...
                  <Link
                    href="/center-admin/risk/complaints?slaBreached=true"
                    className="text-sm text-purple-600 hover:text-purple-700"
                  >
                    View All
                  </Link>
            ...
            <div className="bg-white rounded-lg shadow-sm border">
              <div className="p-4 border-b border-gray-200">
                <div className="flex justify-between items-center">
                  ...
                  <Link
                    href="/center-admin/risk/complaints?fraudRisk=high"
                    className="text-sm text-purple-600 hover:text-purple-700"
                  >
                    View All
                  </Link>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Link
          href="/center-admin/risk/complaints"
        ...
        <Link
          href="/center-admin/risk/blacklist"
          className="bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow"
        >
          <div className="flex items-center">
        ...
        <Link
          href="/center-admin/risk/escalations"
          className="bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow"
        >
          <div className="flex items-center">
