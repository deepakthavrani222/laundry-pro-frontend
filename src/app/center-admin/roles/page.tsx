...
export default function RolesPage() {
  ...
  const handleInitializeRoles = async () => {
    if (window.confirm('Initialize default system roles? This will create standard roles like Branch Manager, Staff, etc.')) {
      try {
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                  <div className="flex items-center space-x-2">
                    <Link
                      href={`/center-admin/roles/${role._id}`}
                    ...
                    <Link
                      href={`/center-admin/roles/${role._id}/edit`}
                  ...
                  <Link
                    href={`/center-admin/roles/${role._id}/permissions`}
