...
export default function BranchesPage() {
  ...
  const fetchManagers = async () => {
    try {
      const response = await api.get('/center-admin/users?role=branch_manager')
  ...
  const handleAssignManager = async () => {
    ...
    try {
      setAssigning(true)
      await api.post(`/center-admin/branches/${selectedBranch._id}/manager`, {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
        ...
        <div className="flex items-center space-x-3">
          ...
          <Link
            href="/center-admin/branches/new"
      ...
      {showAssignModal && selectedBranch && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl w-full max-w-md p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-800">Assign Branch Manager</h3>
              <button
                onClick={() => {
                  setShowAssignModal(false)
                  setSelectedBranch(null)
            ...
            <div className="mb-6">
              ...
              {managers.length === 0 ? (
                <div className="text-center py-4 text-gray-500 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm">No available branch managers</p>
                  <p className="text-xs mt-1">Create a user with Branch Manager role first</p>
                </div>
              ) : (
                <select
