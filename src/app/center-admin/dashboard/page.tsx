    ...
    <div className="space-y-6 pb-8">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <Link href="/center-admin/analytics" className="group flex items-center justify-center p-5 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-2xl hover:from-purple-600 hover:to-pink-600 transition-all shadow-lg shadow-purple-500/30 hover:-translate-y-1">
            <TrendingUp className="w-5 h-5 mr-2 group-hover:scale-110 transition-transform" />
            <span className="font-medium">View Analytics</span>
          </Link>
          <Link href="/center-admin/financial" className="group flex items-center justify-center p-5 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-2xl hover:from-blue-600 hover:to-cyan-600 transition-all shadow-lg shadow-blue-500/30 hover:-translate-y-1">
            <Calendar className="w-5 h-5 mr-2 group-hover:scale-110 transition-transform" />
            <span className="font-medium">Financial Reports</span>
          </Link>
          <Link href="/center-admin/orders" className="group flex items-center justify-center p-5 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-2xl hover:from-emerald-600 hover:to-teal-600 transition-all shadow-lg shadow-emerald-500/30 hover:-translate-y-1">
            <CheckCircle className="w-5 h-5 mr-2 group-hover:scale-110 transition-transform" />
            <span className="font-medium">Review Orders</span>
          </Link>
          <Link href="/center-admin/audit" className="group flex items-center justify-center p-5 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-2xl hover:from-amber-600 hover:to-orange-600 transition-all shadow-lg shadow-amber-500/30 hover:-translate-y-1">
