...
export default function CenterAdminOrdersPage() {
  ...
  const fetchOrders = async () => {
    try {
      setLoading(true)
      const response = await api.get('/center-admin/orders')
  ...
  const fetchLogistics = async () => {
    try {
      const response = await api.get('/center-admin/logistics')
  ...
  const handleAssignBranch = async () => {
    ...
    try {
      setUpdating(true)
      await api.put(`/center-admin/orders/${selectedOrder._id}/assign-branch`, {
  ...
  const handleAssignLogistics = async () => {
    ...
    try {
      setUpdating(true)
      await api.put(`/center-admin/orders/${selectedOrder._id}/assign-logistics`, {
  ...
  const handleUpdateStatus = async (orderId: string, newStatus: string) => {
    try {
      setUpdating(true)
      await api.put(`/center-admin/orders/${orderId}/status`, {
        status: newStatus
      })
