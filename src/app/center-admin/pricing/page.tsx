...
export default function PricingManagementPage() {
  ...
  const handleApprove = async (pricingId: string, makeActive: boolean = false) => {
    try {
      ...
      await centerAdminApi.approvePricingConfiguration(pricingId, makeActive)
  ...
  const handleActivate = async (pricingId: string) => {
    try {
      ...
      await centerAdminApi.activatePricingConfiguration(pricingId)
      await fetchPricingConfigurations()
    } catch (err: any) {
      setError(err.message)
    } finally {
  ...
  const handleClone = async (pricingId: string, newVersion: string, newName?: string) => {
    try {
      ...
      await centerAdminApi.clonePricingConfiguration(pricingId, newVersion, newName)
      await fetchPricingConfigurations()
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <Link
          href="/center-admin/pricing/create"
